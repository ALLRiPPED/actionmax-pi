...
void draw_border(SDL_Surface *candidate, int w, int h) {

    if (!g_border) return;

    int s = g_border_width;
    ...
    SDL_FillRect(candidate, &tb, SDL_MapRGB(candidate->format, 255, 255, 255));
    SDL_FillRect(candidate, &lb, SDL_MapRGB(candidate->format, 255, 255, 255));
    SDL_FillRect(candidate, &rb, SDL_MapRGB(candidate->format, 255, 255, 255));
    SDL_FillRect(candidate, &bb, SDL_MapRGB(candidate->format, 255, 255, 255));
}
